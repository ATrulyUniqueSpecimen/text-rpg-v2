...
"[project]/text-rpg-v2/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

module.exports = __turbopack_context__.r("[project]/text-rpg-v2/node_modules/next/dist/server/route-modules/app-page/module.compiled.js [app-ssr] (ecmascript)").vendored['react-ssr'].ReactJsxDevRuntime; //# sourceMappingURL=react-jsx-dev-runtime.js.map
}),
...
"[project]/text-rpg-v2/node_modules/inkjs/dist/ink.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class A extends p {
    constructor(){
        super(...arguments), this.name = null, this._content = [], this.namedContent = new Map, this.visitsShouldBeCounted = !1, this.turnIndexShouldBeCounted = !1, this.countingAtStartOnly = !1, this._pathToFirstLeafContent = null;
    }
    get hasValidName() {
    ...
    BuildStringOfHierarchy() {
        ...
        if (a.size > 0) {
            ...
            for (let [, r] of a){
                e.AssertType(r, A, "Can only print out named Containers"), r.BuildStringOfHierarchy(t, n, i), t.AppendLine();
            }
        }
        n--, r(), t.Append("]");
    }
...
class D extends p {
    ...
    Call(t) {
        ...
        let e = !1;
        for (let n of t){
            if (n instanceof R) throw new S("Attempting to perform " + this.name + ' on a void value. Did you forget to "return" a value from a function you called here?');
            n instanceof N && (e = !0);
        }
    ...
    CallType(t) {
        ...
        if (2 == a || 1 == a) {
            ...
            }
            {
                ...
                let i = t(r.value);
                return this.name === D.Int ? C.Create(i, n.Int) : this.name === D.Float ? C.Create(i, n.Float) : C.Create(i, e.valueType);
            }
        }
    ...
    CallBinaryListOperation(t) {
        ...
        if (e.valueType == n.List && i.valueType == n.List) return this.CallType([
            e,
            i
        ]);
    ...
    static AddOpToNativeFunc(t, e, n, i) {
        ...
        r || (r = new D(t, e), this._nativeFunctions.set(t, r)), r.AddOpFuncForType(n, i);
    }
...
class J {
    ...
    static WriteRuntimeObject(t, e) {
        ...
        if (r) {
            let e, n = "->";
            return r.isExternal ? n = "x()" : r.pushesToStack && (r.stackPushType == i.Function ? n = "f()" : r.stackPushType == i.Tunnel && (n = "->t->")), e = r.hasVariableTarget ? r.variableDivertName : r.targetPathString, t.WriteObjectStart(), t.WriteProperty(n, e), r.hasVariableTarget && t.WriteProperty("var", !0), r.isConditional && t.WriteProperty("c", !0), r.externalArgs > 0 && t.WriteIntProperty("exArgs", r.externalArgs), void t.WriteObjectEnd();
        }
        let s = a(e, W);
        ...
        if (S) {
            ...
            return null != e ? t.WriteProperty("CNT?", e) : t.WriteProperty("VAR?", S.name), void t.WriteObjectEnd();
        }
        let y = a(e, L);
        if (y) {
            t.WriteObjectStart();
            let e = y.isGlobal ? "VAR=" : "temp=";
            return t.WriteProperty(e, y.variableName), y.isNewDeclaration || t.WriteProperty("re", !0), void t.WriteObjectEnd();
        }
        if (a(e, R)) return void t.Write("void");
        let v = a(e, j);
    ...
    static JTokenToRuntimeObject(e) {
        ...
        if ("string" == typeof e) {
            ...
            if ("L^" == t && (t = "^"), D.CallExistsWithName(t)) return D.CallWithName(t);
            if ("->->" == t) return I.PopTunnel();
            if ("~ret" == t) return I.PopFunction();
            if ("void" == t) return new R;
        }
        if ("object" == typeof e && !Array.isArray(e)) {
            ...
            if ((n = r["VAR="]) ? (h = !0, u = !0) : (n = r["temp="]) && (h = !0, u = !1), h) {
                let t = n.toString(), e = !r.re, i = new L(t, e);
        ...
        throw new Error("Failed to convert token to runtime object: " + this.toJson(e, [
            "parent"
        ]));
    }
    static toJson(t, e, n) {
    ...
    static JObjectToChoice(t) {
        let e = new B;
        return e.text = t.text.toString(), e.index = parseInt(t.index), e.sourcePath = t.originalChoicePath.toString(), e.originalThreadIndex = parseInt(t.originalThreadIndex), e.pathStringOnChoice = t.targetPath.toString(), e.tags = this.JArrayToTags(t), e;
    }
    static JArrayToTags(t) {
        return t.tags ? t.tags : null;
    }
    static WriteChoice(t, e) {
        t.WriteObjectStart(), t.WriteProperty("text", e.text), t.WriteIntProperty("index", e.index), t.WriteProperty("originalChoicePath", e.sourcePath), t.WriteIntProperty("originalThreadIndex", e.originalThreadIndex), t.WriteProperty("targetPath", e.pathStringOnChoice), this.WriteChoiceTags(t, e), t.WriteObjectEnd();
    }
    ...
    static JTokenToListDefinitions(t) {
        ...
        for(let t in e)if (e.hasOwnProperty(t)) {
            let i = t.toString(), r = e[t], a = new Map;
        ...
        constructor(){
            if (this.threadIndex = 0, this.previousPointer = k.Null, this.callstack = [], arguments[0] && arguments[1]) {
                ...
                for (let e of r){
                    ...
                    let h = !!a.exp, u = new n(s, l, h), c = a.temp;
...
class U extends class {
    ...
    $(t, e) {
        ...
        }
        {
            ...
            let n = C.Create(e);
            if (null == n) throw null == e ? new Error("Cannot pass null to VariableState") : new Error("Invalid value passed to VariableState: " + e.toString());
            this.SetGlobal(t, n);
        }
    }
    constructor(t, e){
        super(), this.variableChangedEventCallbacks = [], this.patch = null, this._defaultGlobalVariables = new Map, this._changedVariablesForBatchObs = new Set, this._batchObservingVariableChanges = !1, this._globalVariables = new Map, this._callStack = t, this._listDefsOrigin = e;
        try {
...
class z {
    ...
    constructor(){
        if (this._changedVariables = new Set, this._visitCounts = new Map, this._turnIndices = new Map, 1 === arguments.length && null !== arguments[0]) {
            let t = arguments[0];
...
class X {
    ...
    SwitchFlow_Internal(t) {
        ...
        if (null === this._namedFlows && (this._namedFlows = new Map, this._namedFlows.set(this.kDefaultFlowName, this._currentFlow)), t === this._currentFlow.name) return;
    ...
    LoadJsonObj(e) {
        ...
        if (null != r) {
            let t = r;
            1 === Object.keys(t).length ? this._namedFlows = null : null === this._namedFlows ? this._namedFlows = new Map : this._namedFlows.clear();
    ...
    TrimNewlinesFromOutputStream() {
        ...
        if (t >= 0) for(e = t; e < this.outputStream.length;){
...
class Q extends p {
    ...
    constructor(){
        ...
        if (null != e && (this._listDefinitions = new M(e)), this._externals = new Map, null !== n) {
    ...
    ProcessChoice(t) {
        ...
        let n = "", i = "", r = [];
        if (t.hasChoiceOnlyContent && (i = this.PopChoiceStringAndTags(r) || ""), t.hasStartContent && (n = this.PopChoiceStringAndTags(r) || ""), t.onceOnly) {
    ...
    PerformLogicAndFlowControl(t) {
        ...
        if (t instanceof I) {
            ...
            switch(e.commandType){
                ...
                case I.CommandType.PopTunnel:
                    let t1 = e.commandType == I.CommandType.PopFunction ? i.Function : i.Tunnel, n = null;
                    if (t1 == i.Tunnel) {
                        let t = this.state.PopEvaluationStack();
                        n = a(t, E), null === n && this.Assert(t instanceof R, "Expected void if ->-> doesn't override target");
                    }
                    if (this.state.TryExitFunctionEvaluationFromGame()) break;
                    if (this.state.callStack.currentElement.type == t1 && this.state.callStack.canPop) this.state.PopCallStack(), n && (this.state.divertedPointer = this.PointerAtPath(n.targetPath));
                    else {
                        let e = new Map;
                        ...
                        let r = "Found " + e.get(t1) + ", when expected " + n;
                        this.Error(r);
                    }
                    break;
                ...
                case I.CommandType.Random:
                    {
                        ...
                        let i = this.state.storySeed + this.state.previousRandom, r = new K(i).next(), s = r % n + e.value;
                ...
                case I.CommandType.SeedRandom:
                    ...
                    this.state.storySeed = c.value, this.state.previousRandom = 0, this.state.PushEvaluationStack(new R);
                    break;
                ...
                case I.CommandType.ListRandom:
                    {
                        ...
                        if (0 == e.Count) n = new g;
                            ...
                            let t = this.state.storySeed + this.state.previousRandom, i = new K(t).next(), r = i % e.Count, a = e.entries();
        ...
        if (t instanceof V) {
            ...
            if (null != e.pathForCount) {
                let t = e.containerForCount, i = this.state.VisitCountForContainer(t);
                n = new _(i);
            } else n = this.state.variablesState.GetVariableWithName(e.name), null == n && (this.Warning("Variable not found: '" + e.name + "'. Using default value of 0 (false). This can happen with temporary variables if the declaration hasn't yet been hit. Globals are always given a default value on load if a value doesn't exist in the save state."), n = new _(0));
    ...
    ChoosePathString(e) {
        ...
        if (this.IfAsyncWeCant("call ChoosePathString right now"), null !== this.onChoosePathString && this.onChoosePathString(e, r), n) this.ResetCallstack();
            ...
            throw null != n && (t = "(" + n.path.toString() + ") "), new Error("Story was running a function " + t + "when you called ChoosePathString(" + e + ") - this is almost certainly not not what you want! Full stack trace: \n" + this.state.callStack.callStackTrace);
        }
    ...
    CallExternalFunction(t, e) {
        ...
        null != o ? (h = C.Create(o), this.Assert(null !== h, "Could not create ink value from returned object of type " + typeof o)) : h = new R, this.state.PushEvaluationStack(h);
    }
    ...
    ValidateExternalBindings() {
        let t = null, e = null, n = arguments[1] || new Set;
        if (arguments[0] instanceof A && (t = arguments[0]), arguments[0] instanceof p && (e = arguments[0]), null === t && null === e) if (this.ValidateExternalBindings(this._mainContentContainer, n), this._hasValidatedExternals = !0, 0 == n.size) this._hasValidatedExternals = !0;
            ...
            if (t && t.isExternal) {
                ...
                if (!this._externals.has(e)) if (this.allowExternalFunctionFallbacks) {
    ...
    ObserveVariable(t, e) {
        ...
        this._variableObservers.has(t) ? this._variableObservers.get(t).push(e) : this._variableObservers.set(t, [
            e
        ]);
    }
...
//# sourceMappingURL=8af24_732cf3ca._.js.map